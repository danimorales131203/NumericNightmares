...
public class Food3 : MonoBehaviour // Define la clase Food que hereda de MonoBehaviour
{
    public Collider2D gridArea; // Área del grid donde aparecerá la comida

    private Snake3 snake; // Referencia al script de la serpiente

    // Método llamado al despertar el objeto
    private void Awake()
    {
        snake = FindObjectOfType<Snake3>(); // Encuentra el script de la serpiente en la escena
    }
