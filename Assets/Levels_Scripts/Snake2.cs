...
public class Snake2 : MonoBehaviour // Define la clase Snake que hereda de MonoBehaviour
{
    ...
    private string[] eatMessages = { // Mensajes mostrados al comer
        "Fórmula de integración de una constante", "∫k**=**+*", "∫kdx=**+C", "∫kdx=kx+C"
    };
    ...
    {
        SceneManager.LoadScene("PhoneCall2"); // Cambia a la escena especificada
    }
}